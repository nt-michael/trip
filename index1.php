...
<div id="wrapper">
    ...
    <article class="parallax-slider">
        <div class="tp-banner-container">
            <div id="banner1" class="tp-banner">
                <ul>
                    <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/home_slider_03.jpg" data-saveperformance="off"  data-title="Parallax 3D">
                        <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/home_slider_03.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <div class="tp-caption slider-title tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                            ...
                            data-endspeed="300" 
                            style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">LET’S DISCOVER THE WORLD<br> TOGETHER
                        </div>
                        <div class="tp-caption slider-title1 tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                            ...
                            data-endelementdelay="0.1" 
                            data-endspeed="300" 
                            style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Template based on deep research on the most popular travel booking websites such as<br> booking.com, tripadvisor, yahoo travel, expedia, priceline, hotels.com, travelocity, kayak, orbitz, etc.<br> This guys can’t be wrong. You should definitely give it a shot :)
                        </div>
                        <div class="tp-caption slider-btn tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                            ...
                            <a href="services.php" class="btn btn-primary btn-normal border-radius">READ MORE</a> 
                        </div>
                    </li>
                </ul>   
            </div>
                ...
                <div class="section-container">
                    <div class="home-form">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="active"><a href="#tab_01" aria-controls="tab_01" role="tab" data-toggle="tab"><i class="icon-hotel68"></i> HOTELS</a></li>
                            <li><a href="#tab_02" aria-controls="tab_02" role="tab" data-toggle="tab"><i class="icon-airplane70"></i> FLIGHTS</a></li>
                            <li><a href="#tab_03" aria-controls="tab_03" role="tab" data-toggle="tab"><i class="icon-sedan3"></i> CARS</a></li>
                            <li><a href="#tab_04" aria-controls="tab_04" role="tab" data-toggle="tab"><i class="icon-location38"></i> TOURS</a></li>
                            <li><a href="#tab_05" aria-controls="tab_05" role="tab" data-toggle="tab"><i class="icon-bicycle12"></i> ACTIVITES</a></li>
                            <li class="pull-right"><h6><i class="fa fa-phone"></i> 1800-3456-7891</h6></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_03">
                                ...
                                <form class="bookform form-inline row">
                                    ...
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check in" id="datepicker4">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check out" id="datepicker5">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_04">
                                ...
                                <form class="bookform form-inline row">
                                    ...
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check in" id="datepicker6">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check out" id="datepicker7">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_05">
                                ...
                                <form class="bookform form-inline row">
                                    ...
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check in" id="datepicker8">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Check out" id="datepicker9">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6 col-xs-12">
            ...
            <div class="popular-destinations clearfix">
                ...
                <div class="tp-banner-container">
                    <div id="banner2" class="tp-banner">
                        <ul>
                            <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/parallax_slider_01.jpg"  data-saveperformance="off"  data-title="Parallax 3D">
                                <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/parallax_slider_01.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                                ...
                                <div class="tp-caption slider-title tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    ...
                                    data-endelementdelay="0.1" 
                                    data-endspeed="300" 
                                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">ATLANTIS - THE PALM
                                    <small>FROM $490</small>
                                </div>
                                <div class="tp-caption slider-title1 tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    data-x="center" 
                                    data-y="341"
                                ...
                                <div class="tp-caption slider-btn tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    ...
                                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">
                                    <a href="services.php" class="btn btn-primary btn-normal border-radius">READ MORE</a> 
                                    <a href="services.php" class="btn btn-white btn-normal border-radius">BOOK TOUR</a>
                                </div>
                            </li>
                            <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/parallax_slider_02.jpg"  data-saveperformance="off"  data-title="Parallax 3D">
                                <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/parallax_slider_02.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                                ...
                                <div class="tp-caption slider-title tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    ...
                                    data-endelementdelay="0.1" 
                                    data-endspeed="300" 
                                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">ISTANBUL - THE HOLIDAY
                                    <small>FROM $908</small>
                                </div>
                                <div class="tp-caption slider-title1 tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    data-x="center" 
                                    data-y="341"
                            ...
                            <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/parallax_slider_03.jpg"  data-saveperformance="off"  data-title="Parallax 3D">
                                <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/parallax_slider_03.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                                ...
                                <div class="tp-caption slider-title tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    ...
                                    data-endelementdelay="0.1" 
                                    data-endspeed="300" 
                                    style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">HAWAI - THE HOLIDAY
                                    <small>FROM $908</small>
                                </div>
                                <div class="tp-caption slider-title1 tp-fade skewfromright randomrotateout tp-resizeme rs-parallaxlevel-2" 
                                    data-x="center" 
                ...
                <div class="row margin-top">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="btn-image">
                            <img src="upload/parallax_slider_01.jpg" alt="">
                            <span><a href="#">HAWAI - THE HOLIDAY</a></span>
                        </div>
                    </div><!-- end col -->
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="btn-image">
                            <img src="upload/parallax_slider_02.jpg" alt="">
                            <span><a href="#">ISTANBUL - THE DREAM</a></span>
                        </div>
                    </div><!-- end col -->
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="btn-image">
                            <img src="upload/parallax_slider_03.jpg" alt="">
                            <span><a href="#">INDIA - THE SCREEM</a></span>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
    ...
    <section class="section-light section clearfix">
        <div class="container">
            <div class="top-destinations clearfix">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="clearfix">
                            <div class="post-media clearfix">
                                <a href="blog-single.php"><img src="upload/desti_01.png" alt="" class="img-responsive"></a>
                            </div><!-- end post-media -->
                    ...
                    <div class="col-sm-6">
                        <div class="clearfix">
                            <div class="post-media clearfix">
                                <a href="blog-single.php"><img src="upload/desti_02.png" alt="" class="img-responsive"></a>
                            </div><!-- end post-media -->
    ...
    <article class="parallax-slider">
        <div class="tp-banner-container">
            <div id="banner3" class="tp-banner">
                <ul>
                    <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/parallax_01.jpg"  data-saveperformance="off"  data-title="Parallax 3D">
                    <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/parallax_01.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"></li>
                    <li data-transition="slideup" data-slotamount="7" data-masterspeed="1000" data-thumb="upload/parallax_02.jpg"  data-saveperformance="off"  data-title="Parallax 3D">
                    <img src="images/dummy.png"  alt="greenbg" data-lazyload="upload/parallax_02.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"></li>
                </ul>   
            </div>
        </div>  
    </article> 
            ...
            <div class="popular-destinations clearfix">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="clearfix">
                            <div class="post-media clearfix">
                                <a href="blog-single.php"><img src="upload/home_blog_01.jpg" alt="" class="img-responsive"></a>
                            </div><!-- end post-media -->
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="clearfix">
                                <div class="col-sm-6">
                                    <div class="post-media clearfix">
                                        <a href="blog-single.php"><img src="upload/home_blog_02.jpg" alt="" class="img-responsive"></a>
                                    </div><!-- end post-media -->
                                </div>
                                <div class="col-sm-6">
                                    <div class="post-title clearfix">
                            ...
                            <div class="clearfix">
                                <div class="col-sm-6">
                                    <div class="post-media clearfix">
                                        <a href="blog-single.php"><img src="upload/home_blog_03.jpg" alt="" class="img-responsive"></a>
                                    </div><!-- end post-media -->
                                </div>
                                <div class="col-sm-6">
                                    <div class="post-title clearfix">
                            ...
                            <div class="clearfix">
                                <div class="col-sm-6">
                                    <div class="post-media clearfix">
                                        <a href="blog-single.php"><img src="upload/home_blog_04.jpg" alt="" class="img-responsive"></a>
                                    </div><!-- end post-media -->
                                </div>
                                <div class="col-sm-6">
                                    <div class="post-title clearfix">
    ...
    <section class="little-padding section clearfix">
        <div class="container">
            <div class="row">
