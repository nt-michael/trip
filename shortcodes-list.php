            ...
            <div class="row">
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="c1">
                                <li>Visual Page Builder Included</li>
                                <li>Many Customizable Options</li>
                                <li>Interactive Page Elements</li>
                                <li>Completely Customizable</li>
                                <li>Free & Dedicated Support</li>
                                <li>Fully responsive lay</li>
                            </ul>
                        </div><!-- end col -->

                        <div class="col-sm-4">
                            <ol class="c2">
                                <li><span>01</span> Visual Page Builder Included</li>
                                <li><span>02</span> Many Customizable Options</li>
                                <li><span>03</span> Interactive Page Elements</li>
                                <li><span>04</span> Completely Customizable</li>
                                <li><span>05</span> Free & Dedicated Support</li>
                                <li><span>06</span> Fully responsive lay</li>
                            </ol>
                        </div><!-- end col -->
