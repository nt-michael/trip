                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="post-wrapper clearfix border-bottom">
                                        ...
                                        <div class="post-title clearfix">
                                            <div class="pull-left">
                                                <h5><a href="blog-single.php">TURKEY</a></h5>
                                                <h6>990 PLACES</h6>
                                            </div>
                                            <div class="pull-right">
                                                <h5>FROM <span>$893</span></h5>
                                            </div>
                                        </div><!-- end ost-title -->
                                        <div class="post-content clearfix">
                                            <p>Template based on deep research on the most popular travel booking websites such as booking.com, tripadvisor, yahoo travel, expedia, priceline, hotels.com, kayak, orbitz, etc. This guys can’t be wrong. You should definitely give it a shot :)</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="post-wrapper clearfix border-bottom">
                                        <div class="post-media clearfix">
                                            <a href="blog-single.php"><img src="upload/desti_04.png" alt="" class="img-responsive"></a>
                                        </div><!-- end post-media -->

                                        <div class="post-title clearfix">
                                            <div class="pull-left">
                                                <h5><a href="blog-single.php">HOLLAND</a></h5>
                                                <h6>990 PLACES</h6>
                                            </div>
                                            <div class="pull-right">
                                                <h5>FROM <span>$664</span></h5>
                                            </div>
                                        </div><!-- end ost-title -->
                                        <div class="post-content clearfix">
                                            <p>Template based on deep research on the most popular travel booking websites such as booking.com, tripadvisor, yahoo travel, expedia, priceline, hotels.com, kayak, orbitz, etc. This guys can’t be wrong. You should definitely give it a shot :)</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="post-wrapper clearfix border-bottom">
                                        <div class="post-media clearfix">
                                            <a href="blog-single.php"><img src="upload/desti_03.png" alt="" class="img-responsive"></a>
                                        </div><!-- end post-media -->

                                        <div class="post-title clearfix">
                                            <div class="pull-left">
                                                <h5><a href="blog-single.php">GERMANY</a></h5>
                                                <h6>990 PLACES</h6>
                                            </div>
                                            <div class="pull-right">
                                                <h5>FROM <span>$123</span></h5>
                                            </div>
                                        </div><!-- end ost-title -->
                                        <div class="post-content clearfix">
                                            <p>Template based on deep research on the most popular travel booking websites such as booking.com, tripadvisor, yahoo travel, expedia, priceline, hotels.com, kayak, orbitz, etc. This guys can’t be wrong. You should definitely give it a shot :)</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="post-wrapper clearfix border-bottom">
                                        <div class="post-media clearfix">
                                            <a href="blog-single.php"><img src="upload/desti_05.png" alt="" class="img-responsive"></a>
                                        </div><!-- end post-media -->

                                        <div class="post-title clearfix">
                                            <div class="pull-left">
                                                <h5><a href="blog-single.php">SUUDI ARABIA REPUBLIC</a></h5>
                                                <h6>990 PLACES</h6>
                                            </div>
                                            <div class="pull-right">
                                                <h5>FROM <span>$444</span></h5>
                                            </div>
                                        </div><!-- end ost-title -->
                                        <div class="post-content clearfix">
                                            <p>Template based on deep research on the most popular travel booking websites such as booking.com, tripadvisor, yahoo travel, expedia, priceline, hotels.com, kayak, orbitz, etc. This guys can’t be wrong. You should definitely give it a shot :)</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="post-wrapper clearfix border-bottom">
                                        ...
                                        <div class="post-title clearfix">
                                            <div class="pull-left">
                                                <h5><a href="blog-single.php">UNITED KINGDOM</a></h5>
                                                <h6>990 PLACES</h6>
                                            </div>
                                            <div class="pull-right">
                                                <h5>FROM <span>$123</span></h5>
