		...
		function saved_element_render( $name, $template_data ){
			...
			$template = '<div class="zn_pb_element_container" data-znname="'.strtolower($name).'" >';
				$template .= '<div class="zn_pb_element" data-template="'.$this->zn_generate_key($name).'" data-level="'.$template_data['level'].'">';
					...
					$template .=  '
					<div class="zn_pb_tpl_actions zn_pb_animate">
						<span class="zn_pb_tpl_actions-title">DRAG ELEMENT TO PAGE</span>
						<a href="#" class="zn_pb_delete_saved_el zn_pb_tpl_actions-btn zn_pb_animate" data-tooltip="DELETE"><span class="dashicons dashicons-trash"></span></a>
					</div>';
				$template .=  '</div>';
			$template .=  '</div>';
