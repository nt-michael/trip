...
--------------------------------------------------------------------------------------------------*/
		function text($option) {
			...
			if ( !empty( $option['std'] ) && !empty ( $option['supports'] ) && $option['supports'] == 'block' ) {
				...
				$output = '<input class="zn_input zn_input_text" type="text" name="'.$option['id'].'" value="'.$t_value.'"  placeholder="'.$option['placeholder'].'">';
			}
	...
	$output = '<div class="zn_row">';
		...
		if( is_array( $config['options'] ) ){
			foreach ($config['options'] as $key => $value) {
				...
				$output .= '<select id="'.$id_base.'_'.$value['id'].'" class="zn_input zn_input_select" name="'.$id_base.'['.$value['id'].']">';
...
--------------------------------------------------------------------------------------------------*/
		function font($option) {
			...
			if ( in_array( 'font', $option['supports'] ) ){
				...
				$output .= '<select id="'.$option['id'].'_font" class="zn_input zn_input_select" name="'.$option['id'].'[font-family]">';
			...
			if ( in_array( 'size', $option['supports'] ) ) {
				...
				$output .= '<select id="'.$option['id'].'_size" class="zn_input zn_input_select" name="'.$option['id'].'[font-size]">';
				$output .= '<option value="">-- select --</option>';
			...
			if ( in_array( 'line', $option['supports'] ) ) {
				...
				$output .= '<select id="'.$option['id'].'_line" class="zn_input zn_input_select" name="'.$option['id'].'[line-height]">';
				$output .= '<option value="">-- select --</option>';
			...
			if ( in_array( 'weight', $option['supports'] ) ) {
				...
				$output .= '<select id="'.$option['id'].'_weight" class="zn_input zn_input_select" name="'.$option['id'].'[font-weight]">';
				$output .= '<option value="">-- select --</option>';
			...
			if ( in_array( 'style', $option['supports'] ) ) {
				...
				$output .= '<select id="'.$option['id'].'_style" class="zn_input zn_input_select" name="'.$option['id'].'[font-style]">';
				$output .= '<option value="">-- select --</option>';
			...
			if ( in_array( 'spacing', $option['supports'] ) ) {
				...
				if ( isset( $option['std']['letter-spacing'] ) ) {
					$saved_style = $option['std']['letter-spacing'];
				}
				else {
					$saved_style = '';
				}
				...
				$output .= '<div class="zn_span4">';
				$output .= '<h4>Letter Spacing</h4>';
				$output .= '<select id="'.$option['id'].'_spacing" class="zn_input zn_input_select" name="'.$option['id'].'[letter-spacing]">';
				$output .= '<option value="">-- select --</option>';

						foreach ( $letter_spacing as $sp ){
							$output .= '<option value="'. $sp .'px" ' . selected( $saved_style , $sp.'px', false) . '>'. $sp .'px</option>';
						}
...
--------------------------------------------------------------------------------------------------*/
		function link($option) {
			...
			// $output .= '<input type="text" class="zn_input zn_input_text zn-form--url-title" name="'.$option['id'].'[title]" value="'.$title.'" placeholder="Title" >';
...
--------------------------------------------------------------------------------------------------*/
		function smart_slider($option) {
			...
			if(isset($option['std']) && !empty($option['std']) ){
				...
				if(is_array($option['std'])){
					$std['lg'] = !empty($option['std']['lg']) ? $option['std']['lg'] : '';
				}
				else{
					$std['lg'] = $option['std'];
				}
				...
				if($support_breakpoints) {
					$std['breakpoints'] = !empty($option['std']['breakpoints']) ? $option['std']['breakpoints'] : '';

					$std['md'] = !empty($option['std']['md']) ? $option['std']['md'] : '';
					$std['unit_md'] = !empty($option['std']['unit_md']) ? $option['std']['unit_md'] : 'px';

					$std['sm'] = !empty($option['std']['sm']) ? $option['std']['sm'] : '';
					$std['unit_sm'] = !empty($option['std']['unit_sm']) ? $option['std']['unit_sm'] : 'px';

					$std['xs'] = !empty($option['std']['xs']) ? $option['std']['xs'] : '';
					$std['unit_xs'] = !empty($option['std']['unit_xs']) ? $option['std']['unit_xs'] : 'px';
				}
				if($support_props){
					$std['properties'] = !empty($option['std']['properties']) ? $option['std']['properties'] : '';
				}
			}
			...
			$output  = '<div class="zn_slider znSmartSlider">';
				...
				if ( $support_props ){
					...
					foreach($option['properties'] as $property){
						...
						$output .= '<input type="radio" class="zn_input" name="'.$option['id'].'[properties]" value="'.$property.'" id="'.$option['id'].'_properties_'.$property.'" '.checked( $current, $property, false ).'><label for="'.$option['id'].'_properties_'.$property.'">'.$property.'</label>';
					}
					$output  .= '</div>';
				}
				...
				$output .= '<input type="number" class="zn_input zn_input_text znSmartSlider-mainInput wp-slider-input " min="'.$min.'" step="'.$step.'" max="'.$max.'" name="'.$option['id'].'[lg]" value="'.$std['lg'].'" '.(isset($option['disabled_slider']) ? 'readonly':'').' >';

				// add units to large
				$output  .= '<select name="'.$option['id'].'[unit_lg]" class="znSmartSlider-mainUnits zn_input_select " '.(isset($option['disabled_slider']) ? 'readonly':'').' >';
				...
				if ( $support_breakpoints ){
					...
					$output  .= '<div class="znSmartSlider-breakpointsWrapper clearfix">';
						...
						$output  .= '<div class="znSmartSlider-breakpointsField" >';
							...
							$output .= '<input type="number" class="zn_input zn_input_text znSmartSlider-breakpointsInput" min="'.$min.'" step="'.$step.'" max="'.$max.'" name="'.$option['id'].'[md]" id="'.$option['id'].'_md" value="'.$std['md'].'" >';
							// add unit list
						...
						$output  .= '<div class="znSmartSlider-breakpointsField" >';
							...
							$output .= '<input type="number" class="zn_input zn_input_text znSmartSlider-breakpointsInput" min="'.$min.'" step="'.$step.'" max="'.$max.'" name="'.$option['id'].'[sm]" id="'.$option['id'].'_sm" value="'.$std['sm'].'" >';
							// add unit list
						...
						$output  .= '<div class="znSmartSlider-breakpointsField znSmartSlider-breakpointsField--last" >';
							...
							$output .= '<input type="number" class="zn_input zn_input_text znSmartSlider-breakpointsInput" min="'.$min.'" step="'.$step.'" max="'.$max.'" name="'.$option['id'].'[xs]" id="'.$option['id'].'_xs" value="'.$std['xs'].'" >';
							// add unit list
  ...
  /**
	...
	function zn_radio( $value )
	{
		...
		foreach ( $value['options'] as $option => $name ) {
			...
			$output .= '<input rel="' . $rel . '" id="' . $label . $i . '" name="' . $value['id'] . '" type="radio" class="zn_radio_check" value="' . $option . '" ' . checked( $value['std'], $option, false ) . ' />';
	...
	function boxmodel($option) {
		...
		$output = '<div class="zn_row zn_row_gutter5 zn-boxmodel js-boxmodel-field">';
			...
			$output .= '<div class="zn_span2 zn-boxmodel-field">';
				$output .= '<input class="zn_input zn_input_text" type="text" name="'.$option['id'].'[top]" id="'.$option['id'].'_top" value="'.$bm_top.'"  placeholder="'.$option['placeholder'].'">';
			...
			$output .= '<div class="zn_span2 zn-boxmodel-field">';
				$output .= '<input class="zn_input zn_input_text" type="text" name="'.$option['id'].'[right]" id="'.$option['id'].'_right" value="'.$bm_right.'"  placeholder="'.$option['placeholder'].'">';
			...
			$output .= '<div class="zn_span2 zn-boxmodel-field">';
				$output .= '<input class="zn_input zn_input_text" type="text" name="'.$option['id'].'[bottom]" id="'.$option['id'].'_bottom" value="'.$bm_bottom.'"  placeholder="'.$option['placeholder'].'">';
			...
			$output .= '<div class="zn_span2 zn-boxmodel-field">';
				$output .= '<input class="zn_input zn_input_text" type="text" name="'.$option['id'].'[left]" id="'.$option['id'].'_left" value="'.$bm_left.'"  placeholder="'.$option['placeholder'].'">';
...
--------------------------------------------------------------------------------------------------*/
	function radio_image($option) {
		...
		foreach ( $option['options'] as $key => $soption ) {
			...
			$dummy = empty($s_value) && $soption['dummy'] == true ? 'data-dummy="1"' : '';
...
--------------------------------------------------------------------------------------------------*/
	function smart_select($option) {
		...
		foreach ( $option['options'] as $key => $soption ) {
			...
			$active = !empty($s_value) && $option['std'] == $s_value ? 'is-active' : '';
	...
	function theme_import_export()
	{
		...
		<div class="zn_option_container clearfix">
			...
			<p class="zn_option_desc"><?php _e('Click the button below to restore a previously exported archive containing the theme options.', 'zn_framework');?></p>
		...
		<div class="zn_option_container clearfix">
			...
			<p class="zn_option_desc"><?php _e('Click the button below to export theme options zip archive.', 'zn_framework');?></p>
			...
			<div class="zn_option_content">
				...
				<div class="exp_images_chb">
					<input type="checkbox"
					       ...
					       class=""
					       value="1"/>
					<label><?php _e('Export images too.', 'zn_framework');?></label>
				</div>
