...
function zn_check_components( $component ){
    ...
    if(isset($component) && !empty($component)){
        ...
        elseif($component == 'cart') return zget_option( 'woo_show_cart', 'zn_woocommerce_options', false, 1 ) == 1 ? true : false;
        ...
        // $header_comps = array();
        // $header_comps['search_box'] = zget_option( 'head_show_search', 'general_options', false, 'yes' ) == 'yes' ? true : false;
        // $header_comps['flags'] = zget_option( 'head_show_flags', 'general_options', false, 1 ) == 1 ? true : false;
        // $header_comps['login'] = zget_option( 'head_show_login', 'general_options', false, 1 ) == 1 ? true : false;
        // $header_comps['register'] = zget_option( 'head_show_register', 'general_options', false, 2 ) == 1 ? true : false;
        // $header_comps['custom_text'] = !empty(zget_option( 'zn_head_s7_toptext', 'general_options', false, '' )) ? true : false;
        // $header_comps['hidden_panel'] = zget_option( 'head_show_support_pnl', 'general_options', false, 'yes' ) == 'yes' ? true : false;
        // $header_comps['social_icons'] = zget_option( 'social_icons_visibility_status', 'general_options', false, 'yes' ) == 'yes' ? true : false;
        // $header_comps['header_nav'] = has_nav_menu( 'header_navigation' ) ? true : false;
        // $header_comps['cta'] = zget_option( 'head_show_cta', 'general_options', false, 'no' ) == 'yes' ? true : false;
        // $header_comps['cart'] = zget_option( 'woo_show_cart', 'zn_woocommerce_options', false, 1 ) == 1 ? true : false;
        // $header_comps['logo'] = zn_get_layout_option( 'head_show_logo', 'general_options', false, 'yes' ) == 'yes' ? true : false;
        // $header_comps['mainmenu'] = has_nav_menu( 'main_navigation' ) ? true : false;

        // if(isset($header_comps[$component])){
        //     return $header_comps[$component];
        // }
    }
}
        ...
        <!-- Login/Register Modal forms - hidden by default to be opened through modal -->
            <div id="login_panel" class="loginbox-popup auth-popup mfp-hide">
                <div class="inner-container login-panel auth-popup-panel">
                    <h3 class="m_title_ext auth-popup-title"><?php _e( "SIGN IN YOUR ACCOUNT TO HAVE ACCESS TO DIFFERENT FEATURES", 'zn_framework' ); ?></h3>
    ...
    if($zn_head_height_enb != 'default'){
        ...
        if(isset($zn_header_height_scheme[$zn_header_layout]) && !empty($zn_header_height_scheme[$zn_header_layout])){
            ...
            elseif( !empty($hr) && $zn_head_height_enb == 'custom_rows'){
                ...
                $hs_top = isset($hr['top']) && !empty($hr['top']) ? (int)$hr['top'] : $hdef['top'];
                $hs_main = isset($hr['main']) && !empty($hr['main']) ? (int)$hr['main'] : $hdef['main'];
                $hs_bottom = isset($hr['bottom']) && !empty($hr['bottom']) ? (int)$hr['bottom'] : $hdef['bottom'];
                $hs_others = isset($hr['others']) && !empty($hr['others']) ? (int)$hr['others'] : $hdef['others'];
            ...
            if( !empty($hs_main) ){
                ...
                $css .= '.site-header.'.$zn_header_layout.' .site-header-main.header-no-top{height:'.($main_height+$top_height).'px}';
                $css .= '.site-header.'.$zn_header_layout.' .site-header-main.header-no-bottom{height:'.($main_height+$bottom_height).'px}';
                $css .= '.site-header.'.$zn_header_layout.' .site-header-main.header-no-top.header-no-bottom{height:'.($main_height+$top_height+$bottom_height).'px}';
            }
...
// add_filter( 'zn_after_body', 'zn_header_height' );
