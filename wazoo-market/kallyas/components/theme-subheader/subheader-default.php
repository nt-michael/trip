                        ...
                        <div class="col-sm-<?php echo $def_cols; ?>">
                            <div class="subheader-titles">
                                ...
                                if ( $args_def_header_title ) {
                                    echo '<' . $title_heading . ' class="subheader-maintitle">' . $args['title'] . '</' . $title_heading . '>';
                                }

                                if ( $args_def_header_subtitle && !empty ( $args['subtitle'] ) ) {
                                    echo '<' . $subtitle_tag . ' class="subheader-subtitle">' . do_shortcode( $args['subtitle'] ) . '</' . $subtitle_tag . '>';
                                }
                                ?>
                            </div>
                        </div>
