 ...
 * --------------------------------------------------------------------------- */
	...
	* --------------------------------------------------------------------------- */
	...
	function zn_layout_register_meta_boxes() {
		add_meta_box( 'zn_layout_options', __( 'My Meta Box', 'textdomain' ), 'zn_layout_display_callback', 'zn_layout', 'normal', 'default' );
	}
	...
	function zn_layout_manager_css(){
		...
		if( $header_style == 'image_color' && $header_style_real != '' ){
			...
			if( $headerLayoutStyle == 'style8' ){
				...
				$css .= '.site-header.style8 .kl-top-header {background:'. $kl_top_header_color . ';}';
				$css .= '.site-header.style8 .kl-main-header {background:'. $kl_main_header_color . ';}';
				$css .= '}';
			}
		}
