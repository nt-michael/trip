...
{
    // [h1a] Content [/h1a]
    return '<h1 class="m_title text-custom">' . do_shortcode( $content ) . '</h1>';
}
...
{
    // [h2a] Content [/h2a]
    return '<h2 class="m_title text-custom">' . do_shortcode( $content ) . '</h2>';
}
...
{
    // [h3a] Content [/h3a]
    return '<h3 class="m_title m_title_ext text-custom">' . do_shortcode( $content ) . '</h3>';
}
