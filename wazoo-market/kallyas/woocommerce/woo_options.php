...
$admin_options[] = array (
   ...
   "options"     => array (
       ...
       "style3"  => __( "Modern - Style #3 (Full-width, No sidebar!)", 'zn_framework' )
   )
);
...
$admin_options[] = array (
    ...
    "type"        => "select",
    "options"     => array (
        "" => __( "Default (Icon + Text)", 'zn_framework' ),
        "icononly" => __( "Default (Icon Only)", 'zn_framework' ),
        "style2" => __( "Basket icon", 'zn_framework' )
    )
);
...
$admin_options[] = array (
    ...
    "description" => __( 'Enter the desired image sizes for <br>the images <strong>in category listings (archives)</strong>.
    <br><br>Unlike sizes from <a href="'.admin_url( 'admin.php?page=wc-settings&tab=products&section=display' ).'">WooCommerce\'s options</a>, these are generated on the fly.
    <br><br>For automatic calculation of either the height or width of the image, simply leave one the field <strong>empty</strong>. If you leave both fields empty, then the sizes will fallback to <a href="'.admin_url( 'admin.php?page=wc-settings&tab=products&section=display' ).'">WC\'s default sizing options</a>.
    <br><br>Please note that the single item image sizes can be set from <a href="'.admin_url( 'admin.php?page=wc-settings&tab=products&section=display' ).'">WooCommerce Display options</a>, as these only apply to category listings/archives.', 'zn_framework' ),
