...
class TH_StaticContentTextAndRegister extends ZnElements
{
	...
	function element()
	{
		...
		?>
<div class="kl-slideshow static-content__slideshow nobg <?php echo $uid; ?> <?php echo $bm_class ?> <?php echo $scr_main_class; ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
