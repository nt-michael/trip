            ...
            foreach ( $options['single_iosslider'] as $slide ) {
                ...
                if($slideType == 'image') {
                    ...
                    if ( $slide_image = $slide['io_slide_image'] ) {
                        ...
                        echo $img_link_start . '<img class="slide-item-bg cover-fit-img '.$io_slide_image_vert_pos.'" src="' . $saved_image . '" ' . $saved_alt . ' ' . $saved_title . '>' . $img_link_end;
                ...
                if(isset ( $slide['io_slide_imgboxes'] ) && ! empty ( $slide['io_slide_imgboxes']) ) {
                    ...
                    if(! empty( $imgb1 ) ){
                        ...
                        echo $io_slide_imgboxes_i1_url['start'] . '<img class="kl-imgbox-img cover-fit-img" src="'.$ib1.'" '.ZngetImageAltFromUrl($ib1, true).' '.ZngetImageTitleFromUrl($ib1, true).'>'. $io_slide_imgboxes_i1_url['end'];
                    }
                    ...
                    if(! empty( $imgb2 ) ){
                        ...
                        echo $io_slide_imgboxes_i2_url['start'] . '<img class="kl-imgbox-img cover-fit-img" src="'.$ib2.'" '.ZngetImageAltFromUrl($ib2, true).' '.ZngetImageTitleFromUrl($ib2, true).'>'. $io_slide_imgboxes_i2_url['end'];
                    }
                    ...
                    if(! empty( $imgb3 ) ){
                        ...
                        echo $io_slide_imgboxes_i3_url['start'] . '<img class="kl-imgbox-img cover-fit-img" src="'.$ib3.'" '.ZngetImageAltFromUrl($ib3, true).' '.ZngetImageTitleFromUrl($ib3, true).'>'. $io_slide_imgboxes_i3_url['end'];
                    }
