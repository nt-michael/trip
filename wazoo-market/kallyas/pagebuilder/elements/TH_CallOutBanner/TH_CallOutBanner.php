				...
				echo '<div class="col-sm-2">';
					...
					echo $cab_button_link['start'];
						...
						if ( ! empty ( $options['cab_button_image'] ) ) {
							echo '<span class="symbol circlehover-symbol u-trans-all-2s"><img class="circlehover-symbol-img" src="' . $options['cab_button_image'] . '" alt="'. ZngetImageAltFromUrl( $options['cab_button_image'] ) .'" title="'. ZngetImageTitleFromUrl( $options['cab_button_image'] ) .'"></span>';
						}
						else {
							echo '<span class="symbol u-trans-all-2s"><img class="circlehover-symbol-img" src="' . THEME_BASE_URI . '/images/ok.png" alt="'. __('OK!','zn_framework') .'"></span>';
						}
