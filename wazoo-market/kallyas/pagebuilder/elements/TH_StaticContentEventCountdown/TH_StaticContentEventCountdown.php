...
<div class="kl-slideshow static-content__slideshow <?php echo $style; ?> <?php echo $this->data['uid']; ?> <?php echo $bm_class ?> <?php echo $scr_main_class; ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
