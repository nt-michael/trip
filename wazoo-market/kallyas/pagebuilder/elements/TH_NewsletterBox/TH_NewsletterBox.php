		...
		<div class="elm-nlbox <?php echo implode(' ', $elm_classes); ?>" <?php echo $attributes; ?>>
			...
			?>
				<form method="post" class="elm-nlbox__form clearfix" data-url="<?php echo trailingslashit(home_url()) ?>" name="newsletter_form">
					...
					<button type="submit" name="submit" class="elm-nlbox__submit nl-submit <?php echo $this->opt('button_corners', 'btn--rounded'); ?>">
						<?php
				...
				'options' => array(
					...
					array (
						...
						"options"     => array (
							...
							'lined_dark'  => __( 'White Lined Input + filled button', 'zn_framework' ),
						),
						'live' => array(
						   'type'        => 'class',
						   'css_class' => '.'.$uid,
