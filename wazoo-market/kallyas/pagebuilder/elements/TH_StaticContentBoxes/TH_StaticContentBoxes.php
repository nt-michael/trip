								...
								echo '<div class="col-sm-4">';
									echo '<div class="static-content__infopop">';
										if ( ! empty ( $options['ww_box1_image'] ) ) {
											echo '<img src="' . $options['ww_box1_image'] . '" alt="'. ZngetImageAltFromUrl( $options['ww_box1_image'] ) .'" title="'.ZngetImageTitleFromUrl( $options['ww_box1_image'] ).'" class="sc__img"/>';
										}
								...
								echo '<div class="col-sm-4">';
									echo '<div class="static-content__infopop">';
										if ( ! empty ( $options['ww_box2_image'] ) ) {
											echo '<img src="' . $options['ww_box2_image'] . '" alt="'. ZngetImageAltFromUrl( $options['ww_box2_image'] ) .'" title="'.ZngetImageTitleFromUrl( $options['ww_box2_image'] ).'" class="sc__img"/>';
										}
								...
								echo '<div class="col-sm-4">';
									echo '<div class="static-content__infopop">';
										if ( ! empty ( $options['ww_box3_image'] ) ) {
											echo '<img src="' . $options['ww_box3_image'] . '" alt="'. ZngetImageAltFromUrl( $options['ww_box3_image'] ) .'" title="'.ZngetImageTitleFromUrl( $options['ww_box3_image'] ).'" class="sc__img"/>';
										}
