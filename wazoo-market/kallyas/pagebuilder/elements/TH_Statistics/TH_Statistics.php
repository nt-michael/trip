					...
					if( isset( $item['th_stat_single_iconimg']) && !empty( $item['th_stat_single_iconimg'] )){
						$iconhtml .= '
							<div class="statistic-box__icon-holder statistic-box__icon-holder--img">
								<img class="statistic-box__icon statistic-box__iconimg" src="'.$item['th_stat_single_iconimg'].'" alt="'. ZngetImageAltFromUrl( $item['th_stat_single_iconimg'] ) .'" title="'.ZngetImageTitleFromUrl( $item['th_stat_single_iconimg'] ).'"/>
							</div>
						';
					}
