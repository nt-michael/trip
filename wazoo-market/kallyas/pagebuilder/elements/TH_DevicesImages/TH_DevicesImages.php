...
<?php if($image_type == 'macbook'){ ?>
	...
	<div class="el-di__laptop <?php echo $appear_effect; ?>">
		<img class="el-di__laptop-img cover-fit-img" src="<?php echo $di_macbook_image; ?>" <?php echo ZngetImageAltFromUrl( $di_macbook_image, true ); ?> <?php echo ZngetImageTitleFromUrl( $di_macbook_image, true ); ?>>
	</div>
	<?php } ?>
...
<?php } else { ?>
	...
	<div class="el-di__frame <?php echo $appear_effect; ?>">
		<img class="el-di__frame-img cover-fit-img" src="<?php echo $di_frame_image; ?>" <?php echo ZngetImageAltFromUrl( $di_frame_image, true ); ?> <?php echo ZngetImageTitleFromUrl( $di_frame_image, true ); ?>>
	</div>
	<?php } ?>
...
<?php } ?>
	...
	<div class="el-di__smartphone <?php echo $appear_effect; ?>">
		<img class="el-di__smartphone-img cover-fit-img" src="<?php echo $di_iphone_image; ?>" <?php echo ZngetImageAltFromUrl( $di_iphone_image, true ); ?> <?php echo ZngetImageTitleFromUrl( $di_iphone_image, true ); ?>>
	</div>
	<?php } ?>
