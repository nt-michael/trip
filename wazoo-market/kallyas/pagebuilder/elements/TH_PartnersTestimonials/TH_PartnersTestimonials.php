		...
		<div class="ts-pt-testimonials__item ts-pt-testimonials__item--size-<?php echo $tst['tst_size']; ?> ts-pt-testimonials__item--<?php echo $tst_layout; ?>" style="<?php echo $margin_top; ?> <?php echo $margin_bottom; ?>">
			...
			<div class="ts-pt-testimonials__infos ts-pt-testimonials__infos--<?php echo empty( $tst['tst_img'] ) ? 'noimg':''; ?>">
				...
				<?php if( !empty( $tst['tst_img'] ) ):
					...
					$tst_img = $tst['tst_img'];
					?>
					<img class="ts-pt-testimonials__img cover-fit-img" src="<?php echo $tst_img ?>" <?php echo ZngetImageAltFromUrl($tst_img, true); echo ZngetImageTitleFromUrl($tst_img, true); ?>>
				 <?php endif; ?>
				...
				<div class="ts-pt-partners__carousel-item">
					...
					<?php echo $prt_link['start']; ?>
						...
						<?php if( !empty( $prt['prt_img'] ) ): ?>
							<img class="ts-pt-partners__img img-responsive" src="<?php echo $prt['prt_img']; ?>" alt="<?php echo ZngetImageAltFromUrl( $prt['prt_img'] ) ; ?>" title="<?php echo ZngetImageTitleFromUrl( $prt['prt_img'] ); ?>" />
						<?php endif; ?>
