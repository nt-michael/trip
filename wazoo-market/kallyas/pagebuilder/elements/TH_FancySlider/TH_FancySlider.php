									...
									if ( isset ( $options['single_fancy'] ) && is_array( $options['single_fancy'] ) ) {
										foreach ( $options['single_fancy'] as $slide ) {
											...
											if ( isset ( $slide['ww_slide_image'] ) && ! empty ( $slide['ww_slide_image'] ) ) {
												echo '<img class="zn_fancy_slider-itemimg cover-fit-img img-responsive" src="'.$slide['ww_slide_image'].'" alt="'. ZngetImageAltFromUrl( $slide['ww_slide_image'] ) .'" title="'.ZngetImageTitleFromUrl( $slide['ww_slide_image'] ).'"/>';
											}
