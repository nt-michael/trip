				...
				<div class="row">
					<div class="col-sm-2">
						...
						elseif ( ! empty ( $options['pl_title'] ) && $options['pl_title_style'] == 'style2' ) {
							echo '<h4 class="m_title text-custom partners_carousel-title element-scheme__hdg1"><span>' . $options['pl_title'] . '</span></h4>';
						}
						?>
					...
					<div class="col-sm-10">
						<ul class="partners_carousel partners_carousel-list fixclear partners_carousel_trigger" data-autoplay="<?php echo $autoscroll ? 'true' : 'false'; ?>">
							<?php
							if ( ! empty ( $options['partners_single'] ) && is_array( $options['partners_single'] ) ) {
								foreach ( $options['partners_single'] as $partner ) {
									...
									if ( $slide_image = $partner['lp_single_logo'] ) {
										...
										echo $lp_link['start'];
										echo '<img class="partners_carousel-img" src="' . $saved_image . '" alt="' . $saved_alt . '" ' . $saved_title . '/>';
										echo $lp_link['end'];
										echo '</li>';
