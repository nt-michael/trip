		...
		$options = array(
			...
			'misc' => array(
				...
				'options' => array(
					...
					array(
						"name" => "Google Maps Api Key (Optional)",
			        ...
			        <div class="kl-contentmaps__panel">
			            ...
			            <?php if($this->opt('sc_map_panel_img','') && $panel_img = $this->opt('sc_map_panel_img','')){ ?>
			                ...
			                <a href="<?php echo $panel_img ?>" data-lightbox="image" class="kl-contentmaps__panel-img">
								<img src="<?php echo $panel_img ?>" <?php echo ZngetImageAltFromUrl($panel_img, true); ?> <?php echo ZngetImageTitleFromUrl($panel_img, true); ?> class="kl-contentmaps__panel-img cover-fit-img">
			                </a>
			            <?php } ?>
