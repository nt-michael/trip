...
class TH_PortfolioSlider extends ZnElements
{
	...
	function element()
	{
		...
		<div class="kl-slideshow portfolio-slider__sideshow gradient <?php echo $style; ?> <?php echo $bm_class ?> <?php echo $scr_main_class; ?> <?php echo $this->data['uid']; ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
									...
									foreach ( $options['single_pslides'] as $k => $slide ) {
										...
										if ( isset ( $slide['ps_slide_image3'] ) && ! empty ( $slide['ps_slide_image3'] ) ) {
											...
											if( isset($slide['ps_slide_image3']) && !empty($slide['ps_slide_image3']) ){
												...
												echo '<img class="psl__img-bg cover-fit-img" src="' . $sl_img3 . '" '.ZngetImageAltFromUrl($sl_img3, true).' '.ZngetImageTitleFromUrl($sl_img3, true).'>';
											}
											echo '</div>';
										}
										...
										if ( isset ( $slide['ps_slide_image2'] ) && ! empty ( $slide['ps_slide_image2'] ) ) {
											...
											if( isset($slide['ps_slide_image2']) && !empty($slide['ps_slide_image2']) ){
												...
												echo '<img class="psl__img-bg cover-fit-img" src="' . $sl_img2 . '" '.ZngetImageAltFromUrl($sl_img2, true).' '.ZngetImageTitleFromUrl($sl_img2, true).'>';
											}
											echo '</div>';
										}
										...
										if ( isset ( $slide['ps_slide_image1'] ) && ! empty ( $slide['ps_slide_image1'] ) ) {
											...
											if( isset($slide['ps_slide_image1']) && !empty($slide['ps_slide_image1']) ){
												...
												echo '<img class="psl__img-bg cover-fit-img" src="' . $sl_img1 . '" '.ZngetImageAltFromUrl($sl_img1, true).' '.ZngetImageTitleFromUrl($sl_img1, true).'>';
											}
											echo '</div>';
										}
