			...
			<div class="services_box__inner clearfix">
				...
				if ( ! empty ( $image ) && $sbx_type == 'img' ) {
					...
					echo '<div class="services_box__icon '.(! empty ( $hover_image ) ? 'sb--hashover':'').'">';
						echo '<div class="services_box__icon-inner">';
							...
							echo '<img src="' . $image . '" alt="'. ZngetImageAltFromUrl( $image ) .'" title="'.ZngetImageTitleFromUrl( $image ).'" class="services_box__iconimg services_box__iconimg-main">';

							if ( ! empty ( $hover_image ) ) {
								echo '<img src="' . $hover_image . '" alt="'. ZngetImageAltFromUrl( $hover_image ) .'" title="'.ZngetImageTitleFromUrl( $hover_image ).'" class="services_box__iconimg services_box__iconimg-hover ">';
							}
				...
				echo '<div class="services_box__content">';
					...
					if ( ! empty ( $title ) ) {
						...
						echo '<h4 class="services_box__title '.$custom__title_classes.' ">' . $title . '</h4>';
					}
