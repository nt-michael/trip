...
class ZnSection extends ZnElements {
			...
			'background' => array(
				...
				'options' => array(
					...
					array (
						...
						"description" => __( "Please select wether you want the background image or background OVERLAY color to be skewed.", 'zn_framework' ),
						"id"          => "skewed_bg",
						"std"         => "no",
						"type"        => "select",
						"options"     => array (
	...
	function element() {
		...
		?>
		<section class="zn_section <?php echo implode(' ', $section_classes); ?>" id="<?php echo $uid; ?>" <?php echo implode(' ', $other_attrs); ?> <?php echo $attributes; ?>>
