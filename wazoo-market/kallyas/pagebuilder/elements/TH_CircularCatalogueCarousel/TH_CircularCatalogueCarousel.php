						...
						foreach ( $singleItem as $slide )
						{
							...
							echo '<div class="ca-item-main">';
								...
								if ( isset ( $slide['ww_slide_image'] ) && ! empty ( $slide['ww_slide_image'] ) ) {
									echo '<img class="ca-background-img cover-fit-img" src="' . $slide['ww_slide_image'] . '" alt="'.ZngetImageAltFromUrl( $slide['ww_slide_image'] ).'" title="'.ZngetImageTitleFromUrl( $slide['ww_slide_image'] ).'">';
								}
								echo '</div>';
									...
									if( $gal_img1 || $gal_img2 || $gal_img3 ){
										...
										echo '<ul class="ca-gallery mfp-gallery mfp-gallery--images">';
											if( $gal_img1 ){
												...
												echo '<li><a href="'.$slide['cc_sidegal1'].'"><img src="'.$gal_img1_resize['url'].'" alt="'.ZngetImageAltFromUrl( $slide['cc_sidegal1'] ).'" title="'.ZngetImageTitleFromUrl( $slide['cc_sidegal1'] ).'" class="img-responsive"></a></li>';
											}
											if( $gal_img2 ){
												$gal_img2_resize = vt_resize( '', $slide['cc_sidegal2'], $img_width, $img_height, true );
												echo '<li><a href="'.$slide['cc_sidegal2'].'"><img src="'.$gal_img2_resize['url'].'" alt="'.ZngetImageAltFromUrl( $slide['cc_sidegal2'] ).'" title="'.ZngetImageTitleFromUrl( $slide['cc_sidegal2'] ).'" class="img-responsive"></a></li>';
											}
											if( $gal_img3 ){
												$gal_img3_resize = vt_resize( '', $slide['cc_sidegal3'], $img_width, $img_height, true );
												echo '<li><a href="'.$slide['cc_sidegal3'].'"><img src="'.$gal_img3_resize['url'].'" alt="'.ZngetImageAltFromUrl( $slide['cc_sidegal3'] ).'" title="'.ZngetImageTitleFromUrl( $slide['cc_sidegal3'] ).'" class="img-responsive"></a></li>';
											}
										echo '</ul>';
									}
