...
<div class="kl-slideshow static-content__slideshow static-simpletext nobg <?php echo $uid; ?> <?php echo $scr_main_class; ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
