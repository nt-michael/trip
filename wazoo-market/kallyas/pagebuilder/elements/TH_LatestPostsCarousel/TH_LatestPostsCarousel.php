				...
				<div class="latest-posts-carousel latest-posts-crs <?php echo $this->data['uid']; ?> <?php echo zn_get_element_classes($options); ?>" <?php echo zn_get_element_attributes($options); ?>>
					<div class="row">
						<div class="col-sm-12">
							...
							<h3 class="m_title m_title_ext text-custom latest-posts-crs-elmtitle"><?php echo $title;?></h3>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
										...
										while ( $theQuery->have_posts() ) {
											...
											if ( has_post_thumbnail( $post->ID ) ) {
												...
												if ( ! empty ( $f_image ) ) {
													...
													$featuredImage = '<img class="latest-posts-crs-img" src="' . $image['url'] . '" alt="' . $alt . '" title="' . $title . '"/>';
												}
											}
											?>
											<li class="post latest-posts-crs-post">
												...
												<h3 class="m_title m_title_ext text-custom latest-posts-crs-title"><a class="latest-posts-crs-title-link" href="<?php echo $permalink;?>"><?php the_title();?></a></h3>
											</li>
										<?php } ?>
								</ul>
							</div>
