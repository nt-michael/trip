...
<head>
    ...
    <title>WAZOO | <?php echo $_SESSION['agence-name']; ?></title>
...
<div id="wrapper">
    ...
    <section id="page-header" class="section background">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3><?php echo $_SESSION['agence-name']; ?></h3>
                    <p>
                    <span class="rating">
                    <?php
                        $i = 0;
                    ...
                    <?php echo $_SESSION['agence-location']; ?></p>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </section><!-- end section -->
                ...
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="single-hotel-wrapper">
                        <div class="single-hotel-image">
                            <img src="/upload/<?php echo$_SESSION['car-gImage']; ?>" alt="" class="img-responsive">
                            <div class="price">
                                <h6><?php echo $_SESSION['car-mark']; ?></h6>
                                <h2><small>FCFA</small><?php echo $_SESSION['fair']; ?><span></span></h2>
                                <a href="car-checkout.php" class="btn btn-primary btn-lg">BOOK NOW</a>
                            </div><!-- end price -->
                            ...
                            <div class="single-hotel-bottom">
                                <p>
                                    <i class="icon-location38"></i> <strong>Area:</strong><?php echo $_SESSION['agence-location']; ?>
                                </p>
                            </div><!-- end bottom -->
                        </div><!-- end image -->
                            ...
                            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                                <div class="book-widget">
                                    ...
                                    <div class="row hotel-desc">
                                        <div class="col-md-12">
                                            <h5>Description</h5>
                                            <p><?php echo $_SESSION['car-desc']; ?></p>
                                        </div>
                                    </div><!-- end row -->
                                    <br>
                                    <hr>
