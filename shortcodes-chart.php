...
<div id="wrapper">
                ...
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="row progress-circle">
                        <div class="col-md-3 col-sm-6 text-center wow fadeIn">
                            <div id="circle1" class="circle-stat">
                                <h3>36<span>%</span></h3>
                            </div><!-- end circle-stat -->
                            <div class="stat-details">
                                <h3>CREATIVE IDEAS</h3>
                                <p>Ut wisi enim ad minim veniam, quis nos trud exerci tation ullamcorper.</p>
                            </div><!-- end stat-details -->
                        </div><!-- end col -->
                        
                        <div class="col-md-3 col-sm-6 text-center wow fadeIn">
                            <div id="circle2" class="circle-stat">
                                <h3>58<span>%</span></h3>
                            </div><!-- end circle-stat -->
                            <div class="stat-details">
                                <h3>SOLUTIONS</h3>
                        ...
                        <div class="col-md-3 col-sm-6 text-center wow fadeIn">
                            <div id="circle3" class="circle-stat">
                                <h3>70<span>%</span></h3>
                            </div><!-- end circle-stat -->
                            <div class="stat-details">
                                <h3>PROJECTS</h3>
                        ...
                        <div class="col-md-3 col-sm-6 text-center wow fadeIn">
                            <div id="circle4" class="circle-stat">
                                <h3>90<span>%</span></h3>
                            </div><!-- end circle-stat -->
                            <div class="stat-details">
    ...
    <section class="section section-grey clearfix">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="row progress-circle">
                        <div class="col-md-12 col-sm-12 wow fadeIn">
                            <div class="skills">
                                ...
                                <div class="progress">
                                    <div class="progress-bar yellow" role="progressbar" data-transitiongoal="100"><span>100%</span></div>
                                </div>
                                <h3>RESearch</h3>
                                <div class="progress">
                                    <div class="progress-bar yellow" role="progressbar" data-transitiongoal="86"><span>86%</span></div>
                                </div>
                                <h3>Identity</h3>
                                <div class="progress">
                                    <div class="progress-bar yellow" role="progressbar" data-transitiongoal="66"><span>66%</span></div>
                                </div>
                                <h3>Web Development</h3>
                                <div class="progress">
                                    <div class="progress-bar yellow" role="progressbar" data-transitiongoal="96"><span>96%</span></div>
                                </div>
                            </div><!-- end skills -->
                        </div><!-- end col -->
                    </div><!-- end row -->
