                        ...
                        <div id="content" class="col-md-8 col-sm-12 col-xs-12">
                            <div class="post-wrapper clearfix border-bottom">
                                ...
                                <div class="post-media clearfix">
                                    <a href="blog-single.php"><img src="upload/blog_03.png" alt="" class="img-responsive"></a>
                                </div><!-- end post-media -->
                            ...
                            <div class="post-wrapper clearfix border-bottom">
                                <div class="post-title clearfix">
                                    <h5><a href="blog-single.php">ISTANBUL CARPE DIEM HOTEL</a></h5>
                                </div><!-- end ost-title -->
                                ...
                                <div class="post-media clearfix">
                                    <a href="blog-single.php"><img src="upload/blog_01.png" alt="" class="img-responsive"></a>
                                </div><!-- end post-media -->
                            ...
                            <div class="post-wrapper clearfix border-bottom">
                                <div class="post-title clearfix">
                                    <h5><a href="blog-single.php">AMSTERDAM LIFE STYLE READY FOR USE</a></h5>
                                </div><!-- end ost-title -->
                                ...
                                <div class="post-media clearfix">
                                    <a href="blog-single.php"><img src="upload/blog_02.png" alt="" class="img-responsive"></a>
                                </div><!-- end post-media -->
                            ...
                            <div class="post-wrapper clearfix border-bottom">
                                <div class="post-title clearfix">
                                    <h5><a href="blog-single.php">AN AWESOME HOLIDAY WAITING YOUR NEWS</a></h5>
                                </div><!-- end ost-title -->
                                ...
                                <div class="post-media clearfix">
                                    <a href="blog-single.php"><img src="upload/blog_04.png" alt="" class="img-responsive"></a>
                                </div><!-- end post-media -->
