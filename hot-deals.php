                        ...
                        <div class="navbar-inner">
                            ...
                            <div id="navbar-collapse" class="navbar-right navbar-collapse collapse clearfix">
                                <ul class="nav navbar-nav yamm">
                                    ...
                                    <li><a href="hotels.php">HOTELS</a></li>
                                    <li><a class="active" href="hot-deals.php">HOT DEALS</a></li>
            ...
            <div class="row">
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="post-wrapper row clearfix border-bottom">
                        <div class="col-md-6 col-sm-12">
                            <div class="post-title clearfix">
                                <h5><a href="deal-single.php">THAILAND BY TRAIN - 45% Discount</a></h5>
                            </div><!-- end ost-title -->
                            ...
                            <div class="post-content clearfix">
                                ...
                                <a href="#" class="btn btn-primary btn-sm">Get This Deal</a>
                            </div><!-- end post-content -->
                        </div><!-- end col -->
                        <div class="col-md-6 col-sm-12">
                            <div class="post-media clearfix">
                                <a href="deal-single.php"><img src="upload/blog_03.png" alt="" class="img-responsive"></a>
                    ...
                    <div class="post-wrapper row clearfix border-bottom">
                        <div class="col-md-6 col-sm-12">
                            <div class="post-media clearfix">
                                <a href="deal-single.php"><img src="upload/blog_01.png" alt="" class="img-responsive"></a>
                                <div id="countdown_02" class="deals-count">
                                    <div class="dash days_dash">
                                        <span class="dash_title">days</span>
                                        <div class="digit">0</div>
                                        <div class="digit">0</div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="post-title clearfix">
                                <h5><a href="deal-single.php">ISTANBUL BY TRAIN - 15% Discount</a></h5>
                            </div><!-- end ost-title -->
                            <div class="post-meta clearfix">
                                <span><i class="icon-attach"></i> 03 Feb 2015</span>
                                <span><i class="icon-map110"></i> Asia, Thailand</span>
                    ...
                    <div class="post-wrapper row clearfix border-bottom">
                        <div class="col-md-6 col-sm-12">
                            <div class="post-title clearfix">
                                <h5><a href="deal-single.php">SAPANCA SUMMER BY TRIPS - 20% Discount</a></h5>
                            </div><!-- end ost-title -->
                            <div class="post-meta clearfix">
                                <span><i class="icon-attach"></i> 03 Feb 2015</span>
                                <span><i class="icon-map110"></i> Asia, Thailand</span>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="post-media clearfix">
                                <a href="deal-single.php"><img src="upload/blog_04.png" alt="" class="img-responsive"></a>
                                <div id="countdown_03" class="deals-count">
                                    <div class="dash days_dash">
                                        <span class="dash_title">days</span>
                                        <div class="digit">0</div>
                                        <div class="digit">0</div>
