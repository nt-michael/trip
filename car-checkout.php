...
<head>
    ...
    <title>WAZOO | Car checkout for your reservation</title>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <h6><?php echo $_SESSION['agence-name']; ?></h6>
                                                ...
                                                <ul class="clearfix">
                                                    <li><span>LOCATION:</span> <?php echo $_SESSION['agence-location']; ?></li>
                                                    <li><span>CHECKIN:</span> <?php echo $_SESSION['date-in']; ?></li>
                                                    <li><span>CHECKOUT:</span> <?php echo $_SESSION['date-out']; ?></li>
                                                    <li><span>DRIVE:</span> <?php echo $_SESSION['days']." Day(s)"; ?></li>
                                                    <li><span>Car Brand: </span> <?php echo $_SESSION['car-mark']; ?></li>
                                                </ul>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="bookprice">
                                            <p><strong class="pull-left"><?php echo $_SESSION['days']." Days(s)"; ?> x  Fcfa <?php echo $_SESSION['fair']; ?></strong> <strong class="pull-right">Fcfa <?php $_SESSION['total'] = ($_SESSION['fair']*$_SESSION['days']); echo $_SESSION['total']; ?></strong></p> 
                                            <!--<p><span class="pull-left">Breakfast Included</span></p>-->
                                            <div class="clearfix"></div>
                                            <br>
                                            <p class="lead">A fee of 5% will be added on the amount, as transaction fee which sum up-to <strong><?php $p = $_SESSION['total']; $sum = ((($p*5)/100)+$p); echo $sum; ?> Fcfa</strong></p>
                                        </div><!-- end bookprice -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
