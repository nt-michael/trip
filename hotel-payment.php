...
<head>
    ...
    <title>WAZOO | Checkout your Order</title>
                        ...
                        <div id="content" class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="price-details clearfix">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <ul class="clearfix">
                                                    ...
                                                    <li><span>CHECKIN:</span> <?php echo $_SESSION['checkin']; ?></li>
                                                    <li><span>CHECKOUT:</span> <?php echo $_SESSION['checkout']; ?></li>
                                                    <li><span>STAY:</span> <?php echo $_SESSION['date']." Nights"; ?></li>
                                                    <li><span>ROOM: </span> <?php echo $_SESSION['type-of-room']; ?></li>
                                                </ul>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="bookprice">
                                            <p><strong class="pull-left">2 Nights x 1 Room</strong> <strong class="pull-right">USD 147.68</strong></p> 
                                            <p><span class="pull-left">Breakfast Included</span> <span class="pull-right">USD 160.68</span></p>
                                            <div class="clearfix"></div>
                                            <br>
                                            <p class="lead">Hotel tax 10% not included, Service charge 5% not included</p>
                                        </div><!-- end bookprice -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
