                    ...
                    <div class="single-hotel-wrapper">
                        <div class="single-hotel-image">
                            ...
                            <div class="thumbnails">
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/hotel_01.png"><img src="upload/hotel_01.png" alt="" class="img-responsive"></a>
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/hotel_02.png"><img src="upload/hotel_02.png" alt="" class="img-responsive"></a>
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/hotel_03.png"><img src="upload/hotel_03.png" alt="" class="img-responsive"></a>
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/hotel_04.png"><img src="upload/hotel_04.png" alt="" class="img-responsive"></a>
                            </div><!-- end price -->
                        ...
                        <div class="row">
                            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                                ...
                                <div class="leave-a-feedback text-center clearfix">
                                    <h6>PLEASE <a href="login.php">LOGIN / REGISTER</a> TO LEAVE A FEEDBACK</h6>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="post-wrapper clearfix border-bottom">
                                                <div class="hotel-wrapper">
                                                    ...
                                                    <div class="post-title clearfix">
                                                        <div class="pull-left">
                                                            <h5><a href="hotel-single.php" title="">PRINCIPE FORTE..</a></h5>
                                                        </div><!-- end left -->
                                                        <div class="pull-right">
                                                            <h6>$225</h6>
                                                        </div><!-- end left -->
