...
<head>
    ...
    <title>WAZOO | Hotel checkout for your reservation</title>
                        ...
                        <div id="content" class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="price-details clearfix">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <ul class="clearfix">
                                                    ...
                                                    <li><span>STAY:</span> <?php echo $_SESSION['date']." Night(s)"; ?></li>
                                                    <li><span>ROOM Type: </span> <?php echo $_SESSION['type-of-room']; ?></li>
                                                </ul>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="bookprice">
                                            <p><strong class="pull-left"><?php echo $_SESSION['date']." Night(s)"; ?> x 1 Room</strong> <strong class="pull-right">Fcfa <?php echo $_SESSION['price']; ?></strong></p> 
